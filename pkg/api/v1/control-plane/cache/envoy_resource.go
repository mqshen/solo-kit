...
var _ Resource = &EnvoyResource{}

func NewEnvoyResource(r ResourceProto) *EnvoyResource {
...
func (e *EnvoyResource) Self() XdsResourceReference {
	return XdsResourceReference{
		Name: e.Name(),
		Type: e.Type(),
	}
}
...
func (e *EnvoyResource) ResourceProto() ResourceProto {
...
func (e *EnvoyResource) References() []XdsResourceReference {
	out := make(map[XdsResourceReference]bool)
	res := e.ProtoMessage
	if res == nil {
		return nil
	}
	...
	var references []XdsResourceReference
	for k, _ := range out {
...
// GetResourceName returns the resource name for a valid xDS response type.
func GetResourceName(res ResourceProto) string {
	switch v := res.(type) {
	case *envoy_config_endpoint_v3.ClusterLoadAssignment:
		return v.GetClusterName()
	case *envoy_config_cluster_v3.Cluster:
